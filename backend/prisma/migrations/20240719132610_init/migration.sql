...
CREATE TABLE "UsersBoards" (
    ...
    CONSTRAINT "UsersBoards_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UsersBoards_userId_boardId_key" ON "UsersBoards"("userId", "boardId");
...
-- AddForeignKey
ALTER TABLE "UsersBoards" ADD CONSTRAINT "UsersBoards_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Board"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
